...
Использует passlib с Argon2 для безопасного хеширования паролей.
Argon2 - современный алгоритм, победитель Password Hashing Competition (2015),
не имеет ограничения в 72 байта и считается более безопасным, чем bcrypt.
"""

from passlib.context import CryptContext

# Создаем контекст для хеширования паролей
# Используем Argon2 как основной алгоритм
# Argon2 не имеет ограничения в 72 байта и считается более безопасным
